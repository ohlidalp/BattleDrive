...
-- -- Dragging sheets -- --
-- Drag sheet
BDT_GUI.drag.moveSheet = function( sheet, mouseNewX, mouseNewY, mouseOldX, mouseOldY )
	sheet:move( mouseNewX-mouseOldX, mouseNewY-mouseOldY );
end

-- Drag parent sheet
BDT_GUI.drag.moveParent = function( sheet, mouseNewX, mouseNewY, mouseOldX, mouseOldY )
	sheet.parent:move( mouseNewX-mouseOldX, mouseNewY-mouseOldY );
end
